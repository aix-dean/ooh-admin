...
interface OHPlusMembersListViewProps {
  members: OHPlusMember[]
  loading?: boolean
}

export function OHPlusMembersListView({ members, loading = false }: OHPlusMembersListViewProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="relative">
        ...
        <Input
          placeholder="Search OH! Plus members..."
          value={searchQuery}
